                    ...
                    <div className="main-content main-content-card overflow-auto">
                        <section className="checkout mx-auto">
                            ...
                            <div className="purchase pt-30">
                                ...
                                <Row label="Your Game ID" value="galaxiarmy" />
                                <Row label="Order ID" value="74817481748714" />
                                <Row label="Item" value={123} />
                                <Row label="Price" value={500000} />
                                <Row label="Tax (10%)" value="galaxiarmy" />
                                <Row className="color-palette-4" label="Total" value={7418748147} />
                            </div>
                            <div className="payment pt-10 pb-10">
                                <h2 className="fw-bold text-xl color-palette-1 mb-20">Payment Informations</h2>
                                <Row label="Your Account Name" value="Hanif Pratama Widyanugroho" />
                                <Row label="Type" value="Worldwide Transfer" />
                                <Row label="Bank Name" value="BCA" />
                                <Row label="Bank Account Name" value="PT BCA" />
                                <Row label="Bank Name" value="8441-3131-4144" />
                            </div>
